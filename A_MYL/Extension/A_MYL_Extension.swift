...
public extension CTMediator {
    func A_MYL_demo(name:String, callback:@escaping (String)->Void) -> UIViewController? {
    ...
    func A_MYL_demo_2(name:String, callback:@escaping (String)->Void) -> UIViewController? {
        let params:[AnyHashable:Any] = [
            "name": name,
            "callback": callback,
            kCTMediatorParamsKeySwiftTargetModuleName: ModuleName
